    ...
    <div class="l-container--2col">
        ...
        <div class="l-main">
            <div class="p-mainItem">
                <h2 class="p-level2Heading">営業進捗（今月）</h2>
                <form action="{{ route('user.search') }}" method="get">
                    <div class="p-counterUnit--col2">
                        <div class="p-counter u-mt-0">
                            <input type="hidden" name="operation_start_month" value="{{ \Carbon\Carbon::today()->format("Y-m-d") }}">
                ...
                <div class="p-counter">
                    <form action="{{ route('user.search') }}" method="get">
                        <input type="hidden" name="assign_month" value="{{ \Carbon\Carbon::today()->format("Y-m-d") }}">
                ...
                <div class="p-counter u-mt-10-pc">
                    <form action="{{ route('user.search') }}" method="get">
                        <input type="hidden" name="interview_month" value="{{ \Carbon\Carbon::today()->format("Y-m-d") }}">
