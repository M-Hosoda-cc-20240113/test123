<ol class="p-breadCrumb">
  ...
  @if(url()->current() === route('project.create'))
    <li><a href="{{ route('admin.index') }}"><span>ホーム</span></a></li>
    <li><a href="{{ route('project.list') }}"><span>案件一覧</span></a></li>
    <li><a href="{{ route('project.create') }}"><span>新規登録</span></a></li>
  @endif
  ...
  @if(url()->current() === route('agent.create'))
    <li><a href="{{ route('admin.index') }}"><span>ホーム</span></a></li>
    <li><a href="{{ route('agent.list') }}"><span>案件元会社一覧</span></a></li>
    <li><a href="{{ route('agent.create') }}"><span>新規登録</span></a></li>
  @endif
  ...
  @if(url()->current() === route('position.createForm'))
    <li><a href="{{ route('admin.index') }}"><span>ホーム</span></a></li>
    <li><a href="{{ route('position.list') }}"><span>ポジション一覧</span></a></li>
    <li><a href="{{ route('position.createForm') }}"><span>新規登録</span></a></li>
  @endif
  ...
  @if(url()->current() === route('skill.createForm'))
    <li><a href="{{ route('admin.index') }}"><span>ホーム</span></a></li>
    <li><a href="{{ route('skill.list') }}"><span>スキル一覧</span></a></li>
    <li><a href="{{ route('skill.createForm') }}"><span>新規登録</span></a></li>
  @endif
  ...
  @if(url()->current() === route('level.createForm'))
    <li><a href="{{ route('admin.index') }}"><span>ホーム</span></a></li>
    <li><a href="{{ route('level.list') }}"><span>レベル一覧</span></a></li>
    <li><a href="{{ route('level.createForm') }}"><span>新規登録</span></a></li>
  @endif

  {{-- お知らせリスト --}}
  @if(url()->current() === route('note.list'))
    <li><a href="{{ route('admin.index') }}"><span>ホーム</span></a></li>
    <li><a href="{{ route('note.list') }}"><span>お知らせ一覧</span></a></li>
  @endif
  ...
  @if(Route::currentRouteName() === 'note.detail')
    <li><a href="{{ route('admin.index') }}"><span>ホーム</span></a></li>
    <li><a href="{{ route('note.list') }}"><span>お知らせ一覧</span></a></li>
    <li><a href=""><span>お知らせ詳細</span></a></li>
  @endif
</ol>
